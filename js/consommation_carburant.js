 ...
 * 
 *  @see https://www.convertworld.com/fr/consommation-de-carburant/
 * 
...
function uniteToBase() {
    ...
    switch (uniteDepart) {
        case 'm/ga':
            valeurTemp = valeurConforme * 235,215 ;
            break;
        case 'm/gi':
            valeurTemp = valeurConforme * 282,481;
            break;
        case 'km/l':
            valeurTemp = valeurConforme * 100;
            break;
        case 'l/100km':
...
function formuleUniteToBase() {
    ...
    switch (uniteDepart) {
        case 'm/ga':
            formuleA = valeurConforme + uniteDepart + " x 235,215";
            break;
        case 'm/gi':
            formuleA = valeurConforme + uniteDepart + " x 282,481";
            break;
        case 'km/l':
            formuleA = valeurConforme + uniteDepart + "x 100";
            break;
        case 'l/100km':
...
function baseToUnite() {
    ...
    switch (uniteArrivee) {
        case 'm/ga':
            valeurArrivee = valeurTemp / 235,215;
            break;
        case 'm/gi':
            valeurArrivee = valeurTemp / 282,481;
            break;
        case 'km/l':
            valeurArrivee = valeurTemp / 100;
            break;
        case 'l/100km':
...
function formuleBaseToUnite() {
    ...
    switch (uniteArrivee) {
        case 'm/ga':
            formuleB = "( " + formuleA + " ) / 235,215";
            break;
        case 'm/gi':
            formuleB = "( " + formuleA + " ) / 282,481";
            break;
        case 'km/l':
            formuleB = "( " + formuleA + " ) / 100";
            break;
        case 'l/100km':
            formuleB = "( " + formuleA +" )";
            break;
